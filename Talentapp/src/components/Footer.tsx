  ...
  return (
    <footer className='mt-44 pt-10  pb-10'>
      <div className='flex md:flex-row flex-col md:items-center md:space-y-0 space-y-16 justify-between container text-white'>
        ...
        <div>
            <p className='md:text-xl text-center md:text-start text-lg md:pb-5 pb-2'>
                Connects
            </p>
            <div className='text-sm text-center md:text-start font-light'>
                <p className='cursor-pointer'>Showcase Your Skills</p>
                <p className='cursor-pointer'>Find Talent & Opportunities</p>
                <p className='cursor-pointer'>Get Skill-Verified</p>
                <p className='cursor-pointer'>Read Success Stories</p>
        ...
        <div>
          ...
          <p className='text-sm text-center md:text-start  font-light'>228, Jacob road <br/> Yaba <br/> Lagos State, Nigeria.</p>
        </div>
      </div>
